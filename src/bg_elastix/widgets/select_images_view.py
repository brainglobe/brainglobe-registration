...
class SelectImagesView(QGroupBox):
    ...
    def __init__(self, available_atlases, sample_image_names, parent: QWidget = None):
    ...
    def _on_atlas_index_change(self):
        self.atlas_index_change.emit(self.available_atlas_dropdown.currentIndex())

    def _on_moving_image_index_change(self):
        self.moving_image_index_change.emit(self.available_sample_dropdown.currentIndex())
