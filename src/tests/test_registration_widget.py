...
def test_registration_widget_atlas_selection_initial(make_napari_viewer_with_images):
    widget = RegistrationWidget(make_napari_viewer_with_images)
...
def test_registration_widget_atlas_already_added(make_napari_viewer_with_images):
    widget = RegistrationWidget(make_napari_viewer_with_images)
...
def test_registration_widget_atlas_switch_atlas(make_napari_viewer_with_images):
    widget = RegistrationWidget(make_napari_viewer_with_images)
    widget._atlas = BrainGlobeAtlas('allen_mouse_100um')
